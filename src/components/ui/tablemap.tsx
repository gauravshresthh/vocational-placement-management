...
import { FacilityRequestDrawer } from "@/app/(app)/admin/pre-placements/eligible/facility-request/_components/FacilityRequestDrawer";
...
const TableMap = ({ locations }: { locations: LocationProps[] }) => {
